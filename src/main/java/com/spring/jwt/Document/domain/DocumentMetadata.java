...
public class DocumentMetadata {
     ...
     */
    public static DocumentMetadata from(com.spring.jwt.entity.Document document)
    {
    ...
    /**
     * Business logic methods for document type checking and formatting
     * These methods provide convenient access to common document operations
    ...
    /**
     * Get human-readable file size with appropriate units
     *
     * @return formatted file size (e.g., "1.2 MB", "345 KB", "1024 B")
     */
