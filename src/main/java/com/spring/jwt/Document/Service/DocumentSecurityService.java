...
public interface DocumentSecurityService
{
     ...
     */
    boolean canUploadDocument(Integer userId, DocumentType documentType);
     ...
     * @return true if allowed, false otherwise
     */
    boolean canAccessDocument(Integer userId, Integer documentId);
     ...
     * @return true if allowed, false otherwise
     */
    boolean canModifyDocument(Integer userId, Integer documentId);
     ...
     * @return true if allowed, false otherwise
     */
    boolean canDeleteDocument(Integer userId, Integer documentId);
     ...
     */
    void validateDocumentOwnership(Integer userId, Integer documentId);
